{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "4a740055-2af5-4da4-99fe-122e7da80b79",
          "type": "basic.input",
          "data": {
            "name": "MOSI",
            "pins": [
        ...
        {
          "id": "ea035633-58d0-43dd-939d-fca259352a22",
          "type": "basic.output",
          "data": {
            "name": "MISO",
            "pins": [
        ...
        {
          "id": "42b2d31f-da9d-46a1-82ea-c3d4a4df3c1f",
          "type": "basic.output",
          "data": {
            "name": "MOSI",
            "pins": [
        ...
        {
          "id": "c7e1e327-55eb-4b0f-9d5f-779cd94ad767",
          "type": "basic.input",
          "data": {
            "name": "SCLK",
            "pins": [
        ...
        {
          "id": "702b9afe-3fcf-41d0-8e33-be12a55378fd",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        {
          "id": "b09c6e85-6099-4617-bab3-40657937181f",
          "type": "basic.output",
          "data": {
            "name": "SCLK",
            "pins": [
        ...
        {
          "id": "4742d3a8-7f07-4902-ac62-5f35a7d6194e",
          "type": "basic.input",
          "data": {
            "name": "MISO",
            "pins": [
        ...
        {
          "id": "b07c8f17-fefe-4579-9d78-e9dc2c64027e",
          "type": "basic.input",
          "data": {
            "name": "SS",
            "pins": [
        ...
        {
          "id": "571a2b01-6ac6-4804-b327-035fbe9d72a4",
          "type": "basic.output",
          "data": {
            "name": "ss",
            "pins": [
        ...
        {
          "id": "6e57a8c6-c0a6-4ac2-b5af-9e9f7f9ab1e3",
          "type": "basic.input",
          "data": {
            "name": "boton1",
            "pins": [
        ...
        {
          "id": "ebbdc599-57f2-42ef-ac39-632d4b4dbdc2",
          "type": "basic.output",
          "data": {
            "name": "Serial",
            "pins": [
        ...
        {
          "id": "af12a2bc-af46-4bb2-8367-ae08352f04eb",
          "type": "basic.input",
          "data": {
            "name": "Serial",
            "pins": [
        ...
        {
          "id": "fb978816-e92a-415f-8022-84707651853e",
          "type": "basic.input",
          "data": {
            "name": "boton2",
            "pins": [
        ...
        {
          "id": "ab7a8788-c6e5-4d9f-ad23-c814de3e7dd8",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "c74234ad-1e71-4450-bfc1-ce7fc7d760c6",
          "type": "basic.info",
          "data": {
            "info": "# MAESTRO\n",
            "readonly": true
        ...
        {
          "id": "8b09b9bf-c6e8-4366-8562-6c2cfd605b5b",
          "type": "basic.info",
          "data": {
            "info": "# ESCLAVO",
            "readonly": true
        ...
        {
          "id": "583f6686-7445-4e32-8fdc-d7898fe202c5",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "abcd9d32-47c9-4950-a567-f591212d9a47",
          "type": "basic.info",
          "data": {
            "info": "Datos enviados \nhacia el PC",
            "readonly": true
        ...
        {
          "id": "8f57df2e-228b-473e-8052-7737da95cbab",
        ...
        {
          "id": "889f180b-30d9-4950-9305-329ce850105f",
      ...
      "wires": [
        {
          "source": {
            "block": "8f57df2e-228b-473e-8052-7737da95cbab",
            "port": "6eb027bd-91e5-4fe0-bca4-708d3c38061b"
          },
          "target": {
            "block": "ea035633-58d0-43dd-939d-fca259352a22",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "702b9afe-3fcf-41d0-8e33-be12a55378fd",
            "port": "in"
          },
          "vertices": [],
          "size": 8
        ...
        {
          "source": {
            "block": "4a740055-2af5-4da4-99fe-122e7da80b79",
            "port": "out"
          },
          "target": {
            "block": "8f57df2e-228b-473e-8052-7737da95cbab",
        ...
        {
          "source": {
            "block": "c7e1e327-55eb-4b0f-9d5f-779cd94ad767",
            "port": "out"
          },
          "target": {
            "block": "8f57df2e-228b-473e-8052-7737da95cbab",
        ...
        {
          "source": {
            "block": "b07c8f17-fefe-4579-9d78-e9dc2c64027e",
            "port": "out"
          },
          "target": {
            "block": "8f57df2e-228b-473e-8052-7737da95cbab",
        ...
        {
          "source": {
            "block": "6e57a8c6-c0a6-4ac2-b5af-9e9f7f9ab1e3",
            "port": "out"
          },
          "target": {
            "block": "8f57df2e-228b-473e-8052-7737da95cbab",
        ...
        {
          "source": {
            "block": "fb978816-e92a-415f-8022-84707651853e",
            "port": "out"
          },
          "target": {
            "block": "8f57df2e-228b-473e-8052-7737da95cbab",
        ...
        {
          "source": {
            "block": "889f180b-30d9-4950-9305-329ce850105f",
            "port": "78f7ea6b-2784-4a2f-8f7c-f6eb0ab3c5be"
          },
          "target": {
            "block": "42b2d31f-da9d-46a1-82ea-c3d4a4df3c1f",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "b09c6e85-6099-4617-bab3-40657937181f",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "571a2b01-6ac6-4804-b327-035fbe9d72a4",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "ebbdc599-57f2-42ef-ac39-632d4b4dbdc2",
            "port": "in"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "4742d3a8-7f07-4902-ac62-5f35a7d6194e",
            "port": "out"
          },
          "target": {
            "block": "889f180b-30d9-4950-9305-329ce850105f",
        ...
        {
          "source": {
            "block": "af12a2bc-af46-4bb2-8367-ae08352f04eb",
            "port": "out"
          },
          "target": {
            "block": "889f180b-30d9-4950-9305-329ce850105f",

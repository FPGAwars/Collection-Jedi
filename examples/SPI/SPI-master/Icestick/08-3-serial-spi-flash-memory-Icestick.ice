{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "b6544bb3-3cfc-494c-b022-eea92c6f349d",
          "type": "basic.output",
          "data": {
            "name": "MOSI",
            "pins": [
        ...
        {
          "id": "8131221b-2fd8-45f6-af25-51013756d82e",
          "type": "basic.output",
          "data": {
            "name": "SCLK",
            "pins": [
        ...
        {
          "id": "054f4d11-89b3-4d90-adca-5daa1444883b",
          "type": "basic.input",
          "data": {
            "name": "MISO",
            "pins": [
        ...
        {
          "id": "00fdab6a-9002-41cc-8276-a7f261f615a0",
          "type": "basic.output",
          "data": {
            "name": "ss",
            "pins": [
        ...
        {
          "id": "84119bdb-46cc-49c4-be86-f40c35b0d568",
          "type": "basic.output",
          "data": {
            "name": "Serial",
            "pins": [
        ...
        {
          "id": "1d479059-41e4-47b6-b540-fb3e01cc8b7a",
          "type": "basic.input",
          "data": {
            "name": "Serial",
            "pins": [
        ...
        {
          "id": "14e89861-98c8-4ac9-a203-818d192f546c",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "f238a0d6-7ce3-4d06-8db6-4b0365c007f3",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "39b1d1bd-d330-4e22-ab9f-2024de1c6c3c",
          "type": "basic.info",
          "data": {
            "info": "Datos enviados \nhacia el PC",
            "readonly": true
        ...
        {
          "id": "8a17ff66-9022-4b1d-99ab-9569f1ce8961",
      ...
      "wires": [
        {
          "source": {
            "block": "8a17ff66-9022-4b1d-99ab-9569f1ce8961",
            "port": "78f7ea6b-2784-4a2f-8f7c-f6eb0ab3c5be"
          },
          "target": {
            "block": "b6544bb3-3cfc-494c-b022-eea92c6f349d",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "8131221b-2fd8-45f6-af25-51013756d82e",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "00fdab6a-9002-41cc-8276-a7f261f615a0",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "84119bdb-46cc-49c4-be86-f40c35b0d568",
            "port": "in"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "054f4d11-89b3-4d90-adca-5daa1444883b",
            "port": "out"
          },
          "target": {
            "block": "8a17ff66-9022-4b1d-99ab-9569f1ce8961",
        ...
        {
          "source": {
            "block": "1d479059-41e4-47b6-b540-fb3e01cc8b7a",
            "port": "out"
          },
          "target": {
            "block": "8a17ff66-9022-4b1d-99ab-9569f1ce8961",

{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "309fa135-f9e6-47a7-87fa-b326e9701098",
          "type": "basic.input",
          "data": {
            "name": "MOSI",
            "pins": [
        ...
        {
          "id": "4858d794-4e52-4285-a8b7-4bcfb9b77baf",
          "type": "basic.output",
          "data": {
            "name": "MISO",
            "pins": [
        ...
        {
          "id": "8e843888-5c5e-4f62-8ad4-85799565cdc6",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        {
          "id": "347f79e1-454d-4888-8159-601b87b8fb77",
          "type": "basic.input",
          "data": {
            "name": "SCLK",
            "pins": [
        ...
        {
          "id": "b2edbd91-1caf-4b40-a2eb-2aeb585ae25d",
          "type": "basic.input",
          "data": {
            "name": "SS",
            "pins": [
        ...
        {
          "id": "0f90f9af-e1e0-4867-a3e4-9ac977056c88",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "1",
        ...
        {
          "id": "79c57c20-71aa-4801-94a9-fc3a302d176a",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "606fe5c3-c36b-4538-821d-1437362a71bd",
          "type": "basic.info",
          "data": {
            "info": "**Pines BUS SPI**",
            "readonly": true
        ...
        {
          "id": "3b245069-2ad7-4e5e-ac4a-6e03adea4aa4",
          "type": "basic.info",
          "data": {
            "info": "**Pin BUS SPI**",
            "readonly": true
        ...
        {
          "id": "7b421423-9fda-4dfc-9a60-d81aa734e3ae",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "5a44339d-96d2-45ed-b13e-9e450e2ff293",
        ...
        {
          "id": "6c66378e-1b2c-423f-9f22-991873210a51",
          "type": "basic.info",
          "data": {
            "info": "Dato recibido",
            "readonly": true
        ...
        {
          "id": "c84be287-fa68-4c8c-ac33-640b020cf67d",
          "type": "basic.info",
          "data": {
            "info": "Dato recibido  \nincrementado",
            "readonly": true
        ...
        {
          "id": "5ef23b15-0516-4a6a-9500-852af86df6e1",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "308ae0de-42e9-4b91-ad8e-d386a6a501b3",
      ...
      "wires": [
        {
          "source": {
            "block": "0f90f9af-e1e0-4867-a3e4-9ac977056c88",
            "port": "constant-out"
          },
          "target": {
            "block": "5a44339d-96d2-45ed-b13e-9e450e2ff293",
        ...
        {
          "source": {
            "block": "308ae0de-42e9-4b91-ad8e-d386a6a501b3",
            "port": "b4d1fb2e-3ad7-4d06-84f5-f6160f0f2c53"
          },
          "target": {
            "block": "4858d794-4e52-4285-a8b7-4bcfb9b77baf",
            "port": "in"
          },
          "vertices": []
        },
        ...
        },
        {
          ...
          "target": {
            "block": "8e843888-5c5e-4f62-8ad4-85799565cdc6",
            "port": "in"
          },
          "vertices": [],
          "size": 8
        ...
        {
          "source": {
            "block": "309fa135-f9e6-47a7-87fa-b326e9701098",
            "port": "out"
          },
          "target": {
            "block": "308ae0de-42e9-4b91-ad8e-d386a6a501b3",
        ...
        {
          "source": {
            "block": "347f79e1-454d-4888-8159-601b87b8fb77",
            "port": "out"
          },
          "target": {
            "block": "308ae0de-42e9-4b91-ad8e-d386a6a501b3",
        ...
        {
          "source": {
            "block": "b2edbd91-1caf-4b40-a2eb-2aeb585ae25d",
            "port": "out"
          },
          "target": {
            "block": "308ae0de-42e9-4b91-ad8e-d386a6a501b3",

{
  ...
  "package": {
    ...
    "version": "0.1",
    "description": "Registro de desplazamiento (izquierda) de 4 bits con carga y reset",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "d3a39a11-05f0-430c-8e0e-175a2cef4890",
          "type": "basic.input",
          "data": {
            "name": "rst",
            "pins": [
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "d3a39a11-05f0-430c-8e0e-175a2cef4890",
            "port": "out"
          },
          "target": {
            "block": "db9bff83-fad6-439b-8d86-89e21ad7870d",

{
  ...
  "package": {
    ...
    "version": "0.1",
    "description": "Registro de desplazamiento (izquierda) de 7 bits, con reset",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "1e9f3539-697c-4633-87c1-44c4fd3c4c78",
          "type": "basic.input",
          "data": {
            "name": "rst",
            "pins": [
        ...
        {
          "id": "21dec8b6-5a5c-4622-b98d-da523a6989d9",
          "type": "basic.output",
          "data": {
            "name": "q",
            "range": "[6:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "21dec8b6-5a5c-4622-b98d-da523a6989d9",
            "port": "in"
          },
          "size": 7
        },
        {
          "source": {
            "block": "1e9f3539-697c-4633-87c1-44c4fd3c4c78",
            "port": "out"
          },
          "target": {
            "block": "e46df4d6-ebfb-4445-bc4f-7f082c6b5361",

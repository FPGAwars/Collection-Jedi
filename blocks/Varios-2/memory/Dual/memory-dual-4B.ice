{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3d0daa40-7fc5-4112-bee2-75589178b676",
        ...
        {
          "id": "2813ad68-1a6d-4f63-b347-bb5ccacbe3e1",
        ...
        {
          "id": "45cc6251-41e3-4010-a7c0-92286b22ea44",
          "type": "basic.input",
          "data": {
            "name": "a1",
            "range": "[1:0]",
        ...
        {
          "id": "7849c366-e01d-4590-a6e9-cfb81b2febbb",
          "type": "basic.outputLabel",
          "data": {
            "name": "a0",
            "range": "[1:0]",
        ...
        {
          "id": "12ffc119-c0a3-4e20-8b83-fba50c9966e9",
          "type": "basic.inputLabel",
          "data": {
            "name": "a0",
            "range": "[1:0]",
        ...
        {
          "id": "51d3f5fe-7e51-407f-8fa4-5ca2e4df861e",
          "type": "basic.input",
          "data": {
            "name": "a0",
            "range": "[1:0]",
        ...
        {
          "id": "fbe9cd69-21b6-4966-9bac-e05e19116d5c",
          "type": "d705ff2d565cb77b1265f5998d6788eb66d9aa78",
          "position": {
            "x": 688,
            "y": 656
          },
        ...
        {
          "id": "1339db81-0e35-45f7-93ee-5590c5272c48",
        ...
        {
          "id": "cdecddfc-dc93-4f08-a4c1-e7a1ad81a0cb",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "cdecddfc-dc93-4f08-a4c1-e7a1ad81a0cb",
        ...
        },
        {
          ...
          "target": {
            "block": "1339db81-0e35-45f7-93ee-5590c5272c48",
            "port": "1e7e3cd6-ed00-468a-9f7c-0bb91e020dce"
          }
        },
        {
        ...
        {
          "source": {
            "block": "45cc6251-41e3-4010-a7c0-92286b22ea44",
            "port": "out",
            "size": 2
          },
          "target": {
            "block": "2813ad68-1a6d-4f63-b347-bb5ccacbe3e1",
            "port": "inlabel"
          },
          "size": 2
        },
        {
          "source": {
            "block": "51d3f5fe-7e51-407f-8fa4-5ca2e4df861e",
            "port": "out",
            "size": 2
          },
          "target": {
            "block": "12ffc119-c0a3-4e20-8b83-fba50c9966e9",
            "port": "inlabel"
          },
          "size": 2
        },
        ...
        {
          "source": {
            "block": "7849c366-e01d-4590-a6e9-cfb81b2febbb",
            "port": "outlabel"
          },
          "target": {
            "block": "cdecddfc-dc93-4f08-a4c1-e7a1ad81a0cb",
        ...
        {
          "source": {
            "block": "3d0daa40-7fc5-4112-bee2-75589178b676",
            "port": "outlabel"
          },
          "target": {
            "block": "cdecddfc-dc93-4f08-a4c1-e7a1ad81a0cb",
        ...
        },
        {
          ...
          "target": {
            "block": "fbe9cd69-21b6-4966-9bac-e05e19116d5c",
        ...
        },
        {
          ...
          "target": {
            "block": "fbe9cd69-21b6-4966-9bac-e05e19116d5c",
            "port": "58dde65a-4305-45bb-9ac5-13b8b22e568e"
          },
          "vertices": [
            {
              "x": 616,
  ...
  "dependencies": {
    ...
    "d705ff2d565cb77b1265f5998d6788eb66d9aa78": {
      "package": {
        "name": "Memory-4Bytes",
        "version": "1.0",
        "description": "Memoria de 4 bytes",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "58dde65a-4305-45bb-9ac5-13b8b22e568e",
              "type": "basic.input",
              "data": {
                "name": "a",
                "range": "[1:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "58dde65a-4305-45bb-9ac5-13b8b22e568e",
                "port": "out"
              },
              "target": {
                "block": "8ff8f437-2938-4450-a9cb-e05d255c1871",

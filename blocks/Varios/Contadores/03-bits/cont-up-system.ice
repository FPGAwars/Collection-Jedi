{
  "version": "1.2",
  "package": {
    "name": "Contador-3bits-up-rst-system",
    "version": "0.1",
    "description": "Contador del sistema, módulo M, ascendente, de 3 bits, con reset ",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "9ed3a3c3-51d3-41a6-be8b-5860e474823f",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[2:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "9ed3a3c3-51d3-41a6-be8b-5860e474823f",
            "port": "in"
          },
          "size": 3
        }

{
  ...
  "package": {
    ...
    "version": "0.1",
    "description": "Contador básico, de 4 bits, inicializado a 0 e incremento de 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "5cfeb50e-b973-441f-90b9-a02748e4a335",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[3:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "5cfeb50e-b973-441f-90b9-a02748e4a335",
            "port": "in"
          },
          "size": 4
        }

{
  "version": "1.2",
  "package": {
    "name": "Corazon-tic-Sec-ena",
    "version": "0.1",
    "description": "Corazón de bombeo de tics con periodo paramétrico de segundos y entrada de enable",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "9afe8f35-e9c9-4748-9a7f-97676c0fffe0",
          "type": "basic.input",
          "data": {
            "name": "",
            "pins": [
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "9afe8f35-e9c9-4748-9a7f-97676c0fffe0",
            "port": "out"
          },
          "target": {
            "block": "a70d9684-3b18-4f3d-90cd-28faa893b6b2",

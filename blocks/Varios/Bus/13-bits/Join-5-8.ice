{
  ...
  "package": {
    "name": "Join-5-8",
    "version": "0.0.1",
    "description": "Agregador de buses de 5 y 8 bits a uno de 13bits",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "dd4f63ca-bc02-4e54-b8ea-6be4219263f6",
          "type": "basic.input",
          "data": {
            "name": "i1",
            "range": "[4:0]",
        ...
        {
          "id": "a6e53599-c6a0-498e-b3c2-b2ba1c2a46c1",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[12:0]",
        ...
        {
          "id": "589eb7b5-17eb-42f8-bde1-2b523c2cd870",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[7:0]",
      ...
      "wires": [
        {
          "source": {
            "block": "589eb7b5-17eb-42f8-bde1-2b523c2cd870",
            "port": "out"
          },
          "target": {
        ...
        {
          "source": {
            "block": "dd4f63ca-bc02-4e54-b8ea-6be4219263f6",
            "port": "out"
          },
          "target": {
            "block": "3545528c-05e2-4e95-8223-5b7b77587423",
        ...
        },
        {
          ...
          "target": {
            "block": "a6e53599-c6a0-498e-b3c2-b2ba1c2a46c1",
            "port": "in"
          },
          "size": 13
        }

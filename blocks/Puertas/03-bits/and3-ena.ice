{
  ...
  "package": {
    "name": "AND-3-1",
    "version": "0.1",
    "description": "Habilitación de bus de 3 bits",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "937ea645-f839-4b33-86ef-04ba14fd35fd",
          "type": "basic.input",
          "data": {
            "name": "",
            "range": "[2:0]",
        ...
        {
          "id": "71cf73d2-3b74-4954-b228-9897b9fe17ea",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[2:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "71cf73d2-3b74-4954-b228-9897b9fe17ea",
            "port": "in"
          },
          "size": 3
        },
        {
          "source": {
            "block": "937ea645-f839-4b33-86ef-04ba14fd35fd",
            "port": "out"
          },
          "target": {
            "block": "b6b845d5-ee12-489e-ab57-02389c3f0e43",

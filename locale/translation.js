...
gettext('Jelly-keyboard-test1');
gettext('Alhambra-II');
gettext('MonsterLED');
gettext('01-Green-screen');
gettext('Señales de Rojo y azul **deshabilitadas**');
gettext('**Señal de sincronismo Horizontal**  ');
gettext('**Señal de sincronismo Vertical**');

...
gettext('12-bits');
gettext('write');
gettext('Writing into a 2-bits bus');
gettext('Multiplexor de 2 a 1 de 2 bits');
gettext('write');
gettext('Writing into a 9-bits bus');
gettext('9 bits, 2-1 Multiplexor');
gettext('write');
gettext('Writing into a 12-bits bus');
...
gettext('1-Bit');
gettext('Demux-1-2');
gettext('Demultiplexor de 4 bits, de 1 a 2');
gettext('Demux-1-2');
...
gettext('mux-2-1');
gettext('mux-4-1');
gettext('12-bits 4-1 multiplexer');
gettext('Mux-2-1');
gettext('Multiplexor de 2 a 1 de 13 bits');
gettext('Mux-2-1');
gettext('Multiplexor de 2 a 1 de 14 bits');
gettext('Mux-2-1');
gettext('Multiplexor de 2 a 1 de 15 bits');
gettext('Mux-2-1');
gettext('Multiplexor de 2 a 1 de 16 bits');
gettext('Mux_4in_16bits');
gettext('Multiplexor de 4 a 1 de 16 bits.');
gettext('mux-2-1');
...
gettext('Mux-2-1-flip');
gettext('Multiplexor de 2 a 1 de 32 bits (Flip)');
gettext('Mux-2-1');
...
gettext('Mux-4-1');
gettext('Mux-8-1-flip');
gettext('4-bit 8-1 mux (Flip)');
gettext('Mux-8-1');
gettext('Multiplexor de 8 a 1 de 4 bits');
gettext('Mux16in4bits');
gettext('16 inputs of 4 bits multiplexer');
gettext('Mux-2-1');
...
gettext('Mux32in8bits');
gettext('8-bit multiplexer from 32 inputs to 1.');
gettext('02-bits');
gettext('03-bits');
gettext('04-bits');
gettext('05-bits');
...
gettext('and3-ena');
gettext('Habilitación de bus de 3 bits');
gettext('and3');
gettext('or3');
gettext('Puerta OR de 3 entradas');
gettext('AND4');
gettext('4 inputs AND');
gettext('AND4bus');
gettext('4 bits AND BUS');
gettext('NOR4bus');
gettext('4 inputs bus NOR');
gettext('Separador de bus de 4-bits en 4 cables');
gettext('OR4bus');
gettext('4 inputs bus OR');
gettext('and-4-1');
...
gettext('OR16bus');
gettext('OR 16 bits bus');
gettext('Separador de bus de 16-bits en buses de 8 bits');
gettext('not');
gettext('16-bits bus not gate');
gettext('and');
gettext('AND operation between two 32-bits operands');
gettext('not');
gettext('32-bits bus not gate');
gettext('or');
gettext('OR operation between two 32-bits operands');
gettext('tablas_bin');
gettext('tablas_hex');
...
gettext('Generic');
gettext('Generic 13-bit constant');
gettext('k-1');
...
gettext('reg');
gettext('sreg-load');
gettext('12-bits shift register with load');
gettext('reg-rst');
...
gettext('reg-rst');
gettext('15-bits reg with reset');
gettext('reg');
gettext('15-bits Register');
gettext('reg-rst');
gettext('16-bits reg with reset');
gettext('reg');
gettext('sreg-load');
gettext('16bits Shift register (left) with load');
gettext('sreg');
gettext('Registro de desplazamiento (izquierda) de 16 bits');
gettext('reg-sys');
gettext('23  bit register');
gettext('sreg-left-shift');
gettext('23 bits shift register (left)');
gettext('reg-sys');
gettext('24  bit register');
gettext('reg');
gettext('Registro de 24 bits');
gettext('reg');
gettext('24-bits system register');
gettext('reg-rst');
gettext('32-bit register with load and reset inputs');
gettext('reg');
gettext('32-bit register');
gettext('sreg');
gettext('SPI-master');
gettext('SPI-slave');
...
gettext('Memory-4x1-bits-parallel');
gettext('4x1 bits RAM memory with parallel output');
gettext('Agregador de 4 cables en un bus de 4-bits');
gettext('## Synchronous 4x1-bit RAM (Parallel)\n\n* Both the read and write operation are  \n  synchronous\n* The memory has parallel output');
gettext('standart reading');
gettext('**Each bit is store in its own flip-flop**');
gettext('Memory-8x1-bits-parallel');
...
gettext('memory-cs-2B');
gettext('2x1 Bytes memory with chips select input');
gettext('memory-cs-4B');
...
gettext('sub_2op_16bits');
gettext('Sumador de dos operandos de 16 bits');
gettext('sub_2op_8bits');
gettext('Subtract a - b; 8 bits. ');
gettext('01-bits');
gettext('Shift-left');
gettext('02-bits');
gettext('03-bits');
...
gettext('sum-1op');
gettext('Sumador de un operando de 15 bits con una constante pasada como parámetro (No hay accarreo)');
gettext('sum-2op');
gettext('Sumador de dos operandos de 15 bits');
gettext('sum-1op');
gettext('sum-2op');
gettext('sum-1op');
gettext('23-bits adder. One operand and one constant');
gettext('sum-1op');
gettext('24-bits adder. One operand and one constant');
gettext('sum-24-16');
...
gettext('sum-1op');
gettext('32-bits adder. One operand and one constant');
gettext('sum-2op');
gettext('32-bits adder. Two operands');
gettext('24-bits');
gettext('26-bits');
gettext('accum-sys');
...
gettext('32-bits');
gettext('sign-ext-12-32');
gettext('Sign extension. 12-bit number is extended to 32-bits');
gettext('Separador de bus de 12-bits en uno de 1bit y otro de 11bits');
gettext('Join two buses of 20 and 12 bits into a 32-bit bus');
gettext('Generate a bus of 20 bits with a replica of the input bit');
gettext('Get the sign bit');
gettext('Repeat the sign bit');
gettext('Join number + sign');
...
gettext('join-3-4');
gettext('Join a 3-bit and 4-bits buses into a 7-bits bus');
gettext('join-6-1');
...
gettext('Split-5-3');
gettext('Split an 8bit-bus into two of 5 and 3 bits');
gettext('Split-7-1');
gettext('Split the 8bit bus into two: one of 7-bits and another of 1bit');
gettext('join-3-5');
...
gettext('mult-1-8');
gettext('weight-inverter');
gettext('8-bits bus weight inverter');
gettext('Join-3-1-4');
gettext('Join 3 buses of 3,1 and 4 bits into one of 8-bits');
gettext('Join-3-1-2-2');
gettext('Join 4 buses of 3,1,2 and 2 bits into one of 8-bits');
gettext('Join-1-2-1-2-2');
gettext('Join 5 buses of 1,2,1,2 and 2 bits into one of 8-bits');
gettext('Join-2-1-2-2-1');
gettext('Join 5 buses of 2,1,2,2 and 1 bits into one of 8-bits');
gettext('Split-6-2');
...
gettext('Split-8-2');
gettext('Split the 10-bit bus into a 8-bits bus and a 2-bits bus');
gettext('split-3-8');
...
gettext('joint-4-8');
gettext('Join an 4-bit bus and a 8-bit bus into a 12-bits bus');
gettext('joint-8-4');
gettext('Join an 8-bit bus and a 4-bit bus into a 12-bits bus');
gettext('split-1-11');
gettext('split-3-9');
gettext('Split the 12-bit bus into a 3-bits bus and a 9-bits bus');
gettext('split-3x4');
gettext('Split the 12-bit bus into a 3 buses of 4-bits ');
gettext('split-4-12');
gettext('Split the bus into 4-bit and 12-bit buses');
gettext('split-4-8');
gettext('Split the 12-bit bus into a 4-bits bus and a 8-bits bus');
gettext('split-6-6');
gettext('Split the 12-bit bus into a 6-bits bus and a 6-bits bus');
gettext('split-8-4');
...
gettext('split-4-9');
gettext('Split the 13bits bus into two of 4-bits and 9-bits');
gettext('split-5-8');
...
gettext('Join-4-10');
gettext('Join a 4-bit and 10-bits buses into a 14-bits bus');
gettext('Join-6-8');
gettext('Agregador de buses de 8 y 8 bits a uno de 14bits');
gettext('split-4-10');
gettext('Split the 14-bit bus into 4 and 10 bits');
gettext('split-6-8');
gettext('Separador de bus de 14-bits en uno de 6bit y otro de 8bits');
gettext('Split-2-13');
gettext('Split the 15-bit bus into two buses of2 and 13 bits respectively');
gettext('Split-3-12');
gettext('Split the 15-bit bus into two buses of 3 and 12 bits respectively');
gettext('Split-4-11');
gettext('Split the 15-bit bus into two buses of 4 and 11 bits respectively');
gettext('Split-7-8');
gettext('Split the 15-bit bus into two buses of 7 and 8 bits respectively');
gettext('Agregador');
...
gettext('Join-1-15');
gettext('Join two buses of 1 and 15bits into a new one of 16 bits');
gettext('Join-13-2');
gettext('Joint a 12-bit and 3-bit buses into a 15-bit bus');
gettext('Join-4-12');
gettext('Joint a 4-bit and 12-bit buses into a 16-bit bus');
...
gettext('split-1-15');
gettext('Split the bus into 1-bit and 15-bit buses');
gettext('split-10-6');
gettext('Split the bus into 10-bit and 6-bit buses');
gettext('split-4-12');
gettext('split-7-9');
gettext('Split the bus into 7-bit and 9-bit buses');
gettext('1-8-8-join');
gettext('1-8-8 bus joiner into a 17 bits bus');
...
gettext('split-1-8-8');
gettext('Split a 17 bits bus into three of 1, 8 and 8 bits buses');
gettext('split-8-9');
gettext('Split a 17 bits bus into two of  8 and 9 bits buses');
gettext('split-1-17');
gettext('Split a 18 bits bus into two of  1 and 17 bits buses');
gettext('split-8-10');
gettext('Split a 18 bits bus into two of  8 and 10 bits buses');
gettext('split-2-17');
...
gettext('split-4-16');
gettext('Split a 20-bit bus into one of 4-bits and another of 16-bits');
gettext('split-4-17');
gettext('Split a 21-bit bus into one of 4-bits and another of 17-bits');
gettext('extract-bit');
...
gettext('split_8_8_8');
gettext('24-bits Bus split in three groups of 8 bits.');
gettext('split-1-25');
...
gettext('Split-24-8');
gettext('Split a 32-bits bus into 24-bits bus and 8-bits bus');
gettext('Split-27-5');
gettext('Split a 32-bits bus into 27-bits bus and 5-bits bus');
gettext('05-bits');
gettext('06-bits');
gettext('07-bits');
gettext('09-bits');
...
gettext('less-eq');
gettext('12 bits less or equal than comparator');
gettext('Comp-2');
...
gettext('Comp-2');
gettext('Comp-1');
gettext('15-bits 1-op comparator');
gettext('Comp-2');
gettext('Comparador de dos operandos de 15 bits. Se compara si el operando es igual al parámetro');
gettext('Comp-1');
...
gettext('greater_2op_16bits');
gettext('Comparator greater than, of two operands of 16 bits.');
gettext('Comp-1');
gettext('Comp-2');
gettext('Greather-1');
gettext('Greather-eq-1');
...
gettext('greater_2op_8bits');
gettext('Comparator greater than, of two operands of 8 bits.');
gettext('02-bits');
gettext('03-bits');
gettext('04-bits');
gettext('05-bits');
...
gettext('Count11stop');
gettext('11 bits count machine with stop');
gettext('count');
gettext('Máquina de contar, de 11 bits');
gettext('count-stop');
gettext('Máquina de contar, de 12 bits, con entrada de stop');
gettext('count');
...
gettext('count-stop');
gettext('count');
gettext('Máquina de contar, de 15 bits');
gettext('count');
...
gettext('blocks');
gettext('Bin2ASCII_16bits');
gettext('16 bits binary to ASCII converter.');
...
gettext('Máquina de conversion Binario - BCD de 16 bits');
...
gettext('**BAUDIOS**');
gettext('**Dato**');
gettext('Serial2Binary16bits');
gettext('Converts an ASCII number from serial to 16-bit binary.');
gettext('Detecta números, y cualquier otro caracter lo interpreta como retorno de carro.');
gettext('This separates a numerical data from the others characters, if applicable.');
gettext('Registro doble de 16 bits, con entrada normal y el reset vale el ASCII 48 ->'0'.');
gettext('Converts an ASCII number to 16-bit binary.');
...
gettext('Convierte el valor ASCII a binario de 16 bits.');
gettext('Cuando recibe LF, CR, espacio, coma, punto o barra produce un pulso en \"enter\" para el resto de caracteres da un pulso por \"numb\" (number/número).');
gettext('### ASCII 44, 45, 46 y 47 \n### Corresponde a coma, punto, guión y barra diagonal.');
gettext('Serial2Binary8bits');
gettext('Converts a numeric ASCII input to an 8-bit binary number.');
gettext('Converts an ASCII number to 8 bit binary.');
...
gettext('Stepper motor whith logic control.');
gettext('Contador Up & Down 2 bits sin limitación de comienzo y fin.');
gettext('Memoria nibble con entradas sueltas.');
...
gettext('Contador bidireccional con reset');
...
gettext('Stepper motor logic');
gettext('![](https://groups.google.com/group/fpga-wars-explorando-el-lado-libre/attach/13ceee0323373/stepper%20motor%20logic%20control.PNG?part=0.3&view=1&authuser=0)');
gettext('### QA');
gettext('### QB');
gettext('### ~QB');
gettext('### QA xor QB');
...
gettext('Register with reset; 16 bits.');
gettext('Counter Bidirectional, 16 bits.');
gettext('This separates a numerical data from the others, if applicable.');
gettext('Initial tic.');
...
gettext('Si recibe un número en ASCII saldrá un tic por *numb*, y si detecta enter, espacio, coma, etc, entonces saldrá un tic por *enter*, pero una sóla vez si se repitiesen.');
gettext('l = a < b');

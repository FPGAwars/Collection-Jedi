...
gettext('reg-rst');
gettext('32-bits register with reset');
gettext('reg');
...
gettext('Convierte una entrada ASCII de 8 bits a binario.');
gettext('Detecta char de coma, espacios y returns');
gettext('Convierte un número ASCII a binario de 8 bits.');
